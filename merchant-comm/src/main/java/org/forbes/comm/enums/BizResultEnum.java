...
public enum BizResultEnum {
     ...
     * 经营分类
     **/
    SHOP_CODE_EXISTS("003002001", "经营分类编码已存在", "%s对应经营分类编码已存在"),
    CLASSIFY_CODE_EXISTS("003002002", "经营分类编码已存在", "%s对应经营分类编码已存在"),
    CLASSIFY_TYPE_ID_EXISTS("003002003", "经营分类下存在其他商家", "%s对应经营分类下存在其他商家"),

    /**
     * 商家提现
     **/
    SHOP_CASH_STATUS_NO_EXISTS("003003001", "商家提现状态不存在", "%s对应商家提现状态不存在");
